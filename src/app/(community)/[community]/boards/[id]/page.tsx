            ...
            <div>
              ...
              {isAuth && showStoryForm && (
                <form onSubmit={handleStorySubmit} className="mb-4 bg-surface border border-border-default rounded-xl p-4 space-y-3">
                  ...
                  <div className="flex gap-2">
                    <button type="submit" disabled={storySubmitting || !storyText.trim()} className="px-4 py-1.5 rounded-lg bg-[#1C1917] text-white text-xs font-medium hover:bg-[#292524] disabled:opacity-50 transition-colors">
              ...
              {isAuth && showLinkForm && (
                <form onSubmit={handleLinkSubmit} className="mb-4">
                  <div className="flex gap-2">
                    ...
                    />
                    <button type="submit" disabled={linkSubmitting} className="px-4 py-2 rounded-lg bg-[#1C1917] text-white text-xs font-medium hover:bg-[#292524] disabled:opacity-50 transition-colors shrink-0">
