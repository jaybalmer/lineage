          ...
          <div className="flex justify-center gap-3">
            ...
            {selectedEventId && (
              <button
                ...
                className="px-5 py-2.5 rounded-lg bg-[#1C1917] text-white text-sm font-medium hover:bg-[#292524] transition-colors"
              >
                View event
              </button>
            )}
        ...
        {step === "input" && (
          <div className="space-y-6">
            ...
            <button
              ...
              className="px-6 py-2.5 rounded-lg bg-[#1C1917] text-white text-sm font-medium hover:bg-[#292524] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
            >
            ...
            <div className="flex items-center justify-between gap-4 pt-2 border-t border-border-default">
              ...
              <div className="flex items-center gap-3">
                ...
                <button
                  ...
                  className="px-5 py-2.5 rounded-lg bg-[#1C1917] text-white text-sm font-medium hover:bg-[#292524] transition-colors disabled:opacity-40 disabled:cursor-not-allowed"
                >
