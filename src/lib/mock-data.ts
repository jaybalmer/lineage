...
// ─── Claims ──────────────────────────────────────────────────────────────────
//
// Helper: pull canonical start/end dates from the EVENTS array so event claims
// never store a user-entered date that could diverge from the event record.
function ed(id: string): { start_date: string; end_date?: string } {
  const ev = EVENTS.find((e) => e.id === id)
  if (!ev) return { start_date: "2000-01-01" }
...
export const CLAIMS: Claim[] = [
  // ── Kira Matsuda (u2) — MEDIUM connection to Jay ─────────────────────────
  // North Shore local → shares Cypress, Seymour, Baker, key Baker events
  ...
  { id: "c13", subject_id: "u2", subject_type: "person", predicate: "competed_at",  object_id: "e1",  object_type: "event", ...ed("e1"),  confidence: "documented",    visibility: "public", asserted_by: "u2", created_at: "2026-03-01" },
  ...
  { id: "c63", subject_id: "u2", subject_type: "person", predicate: "competed_at",  object_id: "e10", object_type: "event", ...ed("e10"), confidence: "self-reported", visibility: "public", asserted_by: "u2", created_at: "2026-03-01" },
  { id: "c64", subject_id: "u2", subject_type: "person", predicate: "competed_at",  object_id: "e13", object_type: "event", ...ed("e13"), confidence: "documented",    visibility: "public", asserted_by: "u2", created_at: "2026-03-01", sources: [SOURCES[4]] },
  ...
  { id: "c67", subject_id: "u2", subject_type: "person", predicate: "rode_at",      object_id: "p19", object_type: "place", start_date: "2002-01-01", end_date: "2010-12-31",  confidence: "self-reported", visibility: "public", asserted_by: "u2", created_at: "2026-03-01" },
  { id: "c68", subject_id: "u2", subject_type: "person", predicate: "competed_at",  object_id: "e11", object_type: "event", ...ed("e11"), confidence: "self-reported", visibility: "public", asserted_by: "u2", created_at: "2026-03-01" },
  { id: "c69", subject_id: "u2", subject_type: "person", predicate: "competed_at",  object_id: "e15", object_type: "event", ...ed("e15"), confidence: "documented",    visibility: "public", asserted_by: "u2", created_at: "2026-03-01" },

  // ── Theo Bellamy (u3) — HIGH connection to Jay (50 %+ overlap goal) ───────
  // Whistler local since '98 · major Baker presence · Cypress + Seymour North Shore roots
  ...
  { id: "c71", subject_id: "u3", subject_type: "person", predicate: "rode_at",      object_id: "p26", object_type: "place", start_date: "1998-01-01",                          confidence: "self-reported", visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c72", subject_id: "u3", subject_type: "person", predicate: "competed_at",  object_id: "e12", object_type: "event", ...ed("e12"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c73", subject_id: "u3", subject_type: "person", predicate: "competed_at",  object_id: "e13", object_type: "event", ...ed("e13"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01", sources: [SOURCES[4]] },
  { id: "c74", subject_id: "u3", subject_type: "person", predicate: "competed_at",  object_id: "e14", object_type: "event", ...ed("e14"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  ...
  { id: "c77", subject_id: "u3", subject_type: "person", predicate: "rode_at",      object_id: "p19", object_type: "place", start_date: "1998-01-01", end_date: "2006-12-31",  confidence: "self-reported", visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c78", subject_id: "u3", subject_type: "person", predicate: "rode_at",      object_id: "p2",  object_type: "place", start_date: "1998-01-01", end_date: "2005-12-31",  confidence: "self-reported", visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c79",  subject_id: "u3", subject_type: "person", predicate: "competed_at", object_id: "e10", object_type: "event", ...ed("e10"), confidence: "self-reported", visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c79b", subject_id: "u3", subject_type: "person", predicate: "competed_at", object_id: "e11", object_type: "event", ...ed("e11"), confidence: "self-reported", visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c79c", subject_id: "u3", subject_type: "person", predicate: "competed_at", object_id: "e15", object_type: "event", ...ed("e15"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c79d", subject_id: "u3", subject_type: "person", predicate: "competed_at", object_id: "e16", object_type: "event", ...ed("e16"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },
  { id: "c79e", subject_id: "u3", subject_type: "person", predicate: "competed_at", object_id: "e17", object_type: "event", ...ed("e17"), confidence: "documented",    visibility: "public", asserted_by: "u3", created_at: "2026-03-01" },

  // ── Priya Nair (u4) — LIGHT connection to Jay ─────────────────────────────
  // Revelstoke-based, newer era — limited BC overlap; one shared Baker event
  ...
  { id: "c82", subject_id: "u4", subject_type: "person", predicate: "competed_at",  object_id: "e4",  object_type: "event", ...ed("e4"),  confidence: "documented",    visibility: "public", asserted_by: "u4", created_at: "2026-03-01" },
  { id: "c83", subject_id: "u4", subject_type: "person", predicate: "competed_at",  object_id: "e50", object_type: "event", ...ed("e50"), confidence: "documented",    visibility: "public", asserted_by: "u4", created_at: "2026-03-01" },
  ...
  { id: "c86b", subject_id: "u4", subject_type: "person", predicate: "competed_at", object_id: "e16", object_type: "event", ...ed("e16"), confidence: "documented",    visibility: "public", asserted_by: "u4", created_at: "2026-03-01" },

  // ── Soren Wiig (u5) — NO meaningful connection to Jay ─────────────────────
  // Sun Peaks home base, Interior BC focus — different mountain ecosystem entirely
  ...
  { id: "c91", subject_id: "u5", subject_type: "person", predicate: "rode_at",      object_id: "p1",  object_type: "place", start_date: "2006-01-01", end_date: "2010-12-31",  confidence: "self-reported", visibility: "shared", asserted_by: "u5", created_at: "2026-03-01" },
  { id: "c92", subject_id: "u5", subject_type: "person", predicate: "rode_at",      object_id: "p4",  object_type: "place", start_date: "2008-01-01", end_date: "2015-12-31",  confidence: "self-reported", visibility: "shared", asserted_by: "u5", created_at: "2026-03-01" },
  { id: "c93", subject_id: "u5", subject_type: "person", predicate: "competed_at",  object_id: "e11", object_type: "event", ...ed("e11"), confidence: "self-reported", visibility: "shared", asserted_by: "u5", created_at: "2026-03-01" },
  { id: "c94", subject_id: "u5", subject_type: "person", predicate: "competed_at",  object_id: "e4",  object_type: "event", ...ed("e4"),  confidence: "documented",    visibility: "shared", asserted_by: "u5", created_at: "2026-03-01" },
  ...
  // ── Mara Fonoti (u6) — MEDIUM connection to Jay ───────────────────────────
  // Baker regular + Cypress local · contest career overlaps mid-2000s onward
  ...
  { id: "c103", subject_id: "u6", subject_type: "person", predicate: "competed_at",  object_id: "e14", object_type: "event", ...ed("e14"), confidence: "documented",    visibility: "public", asserted_by: "u6", created_at: "2026-03-01" },
  { id: "c104", subject_id: "u6", subject_type: "person", predicate: "competed_at",  object_id: "e13", object_type: "event", ...ed("e13"), confidence: "documented",    visibility: "public", asserted_by: "u6", created_at: "2026-03-01", sources: [SOURCES[4]] },
  { id: "c105", subject_id: "u6", subject_type: "person", predicate: "competed_at",  object_id: "e15", object_type: "event", ...ed("e15"), confidence: "documented",    visibility: "public", asserted_by: "u6", created_at: "2026-03-01" },
  ...
  { id: "c108b", subject_id: "u6", subject_type: "person", predicate: "rode_at",     object_id: "p19", object_type: "place", start_date: "2007-01-01", end_date: "2014-12-31",  confidence: "self-reported", visibility: "public", asserted_by: "u6", created_at: "2026-03-01" },
  { id: "c108c", subject_id: "u6", subject_type: "person", predicate: "competed_at", object_id: "e16", object_type: "event", ...ed("e16"), confidence: "documented",    visibility: "public", asserted_by: "u6", created_at: "2026-03-01" },
  { id: "c108d", subject_id: "u6", subject_type: "person", predicate: "competed_at", object_id: "e17", object_type: "event", ...ed("e17"), confidence: "documented",    visibility: "public", asserted_by: "u6", created_at: "2026-03-01" },

  // ── Dex Holbrook (u7) — MEDIUM connection to Jay ─────────────────────────
  // Old-school era (riding since '94) · Baker + Whistler overlap across the decades
  ...
  { id: "c112", subject_id: "u7", subject_type: "person", predicate: "rode_at",      object_id: "p26", object_type: "place", start_date: "1995-01-01",                          confidence: "self-reported", visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },
  ...
  { id: "c115", subject_id: "u7", subject_type: "person", predicate: "competed_at",  object_id: "e10", object_type: "event", ...ed("e10"), confidence: "self-reported", visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },
  { id: "c116", subject_id: "u7", subject_type: "person", predicate: "competed_at",  object_id: "e11", object_type: "event", ...ed("e11"), confidence: "documented",    visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },
  { id: "c117", subject_id: "u7", subject_type: "person", predicate: "competed_at",  object_id: "e12", object_type: "event", ...ed("e12"), confidence: "documented",    visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },
  ...
  { id: "c118b", subject_id: "u7", subject_type: "person", predicate: "rode_at",     object_id: "p1",  object_type: "place", start_date: "1999-01-01", end_date: "2007-12-31",  confidence: "self-reported", visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },
  { id: "c118c", subject_id: "u7", subject_type: "person", predicate: "competed_at", object_id: "e13", object_type: "event", ...ed("e13"), confidence: "documented",    visibility: "public", asserted_by: "u7", created_at: "2026-03-01" },

  // ── Jess Cartwright (u8) — LIGHT connection to Jay ────────────────────────
  // Fernie-based, newer era, Baker trips but limited West Coast intersection
  ...
  { id: "c123", subject_id: "u8", subject_type: "person", predicate: "competed_at",  object_id: "e14", object_type: "event", ...ed("e14"), confidence: "documented",    visibility: "public", asserted_by: "u8", created_at: "2026-03-01", sources: [SOURCES[4]] },
  { id: "c124", subject_id: "u8", subject_type: "person", predicate: "competed_at",  object_id: "e15", object_type: "event", ...ed("e15"), confidence: "documented",    visibility: "public", asserted_by: "u8", created_at: "2026-03-01" },
  ...
  { id: "c127b", subject_id: "u8", subject_type: "person", predicate: "competed_at", object_id: "e16", object_type: "event", ...ed("e16"), confidence: "documented",    visibility: "public", asserted_by: "u8", created_at: "2026-03-01" },

  // ── Westbeach org claims ───────────────────────────────────────────────────
  { id: "c_wb1", subject_id: "o25", subject_type: "org", predicate: "organized",   object_id: "ew1", object_type: "event", ...ed("ew1"), confidence: "documented",    visibility: "public", asserted_by: "system", created_at: "2026-03-01" },
  { id: "c_wb2", subject_id: "o25", subject_type: "org", predicate: "organized",   object_id: "ew2", object_type: "event", ...ed("ew2"), confidence: "documented",    visibility: "public", asserted_by: "system", created_at: "2026-03-01" },
  { id: "c_wb3", subject_id: "o25", subject_type: "org", predicate: "organized",   object_id: "ew3", object_type: "event", ...ed("ew3"), confidence: "corroborated",  visibility: "public", asserted_by: "system", created_at: "2026-03-01" },
