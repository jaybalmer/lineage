-- ============================================================================
-- Linestry boards: catalog reconciliation import (ALL STEPS, in order)
-- Generated from reconciliation-decisions.csv. Review before running.
-- 79 merges (UPDATE existing) + 6 imports (INSERT new) + 6 added columns.
--
-- SAFETY: uncomment the backup line below before running step 2 if you want a
-- one-command rollback point (Supabase also has point-in-time restore):
--   create table boards_backup as select * from boards;
-- To roll back: drop table boards; alter table boards_backup rename to boards;
-- ============================================================================
